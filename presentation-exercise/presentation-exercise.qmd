...
Note: For some reason, when I used the print() function on the plot, the R Console returned "NULL" and the plot would not print. However, if I simply highlighted the trump1 argument at the beginning of the plot code, it would print and work as intended (i.e. interactive). I went ahead and downloaded the plot as a .png file and included the plot in this document. 
